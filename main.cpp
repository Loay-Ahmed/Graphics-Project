...
{
	static LPCTSTR currentCursor = IDC_ARROW; // Default cursor
	...
	case WM_KEYDOWN: {
		switch (wp) {
		case '1': currentCursor = IDC_ARROW; break;
		case '2': currentCursor = IDC_CROSS; break;
		case '3': currentCursor = IDC_HAND; break;
		case '4': currentCursor = IDC_WAIT; break;
		case '5': currentCursor = IDC_HELP; break;
		case '6': currentCursor = IDC_IBEAM; break;
		}
		break;
	}
	case WM_LBUTTONUP:
