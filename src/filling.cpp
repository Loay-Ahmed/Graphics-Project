...
void Filling::RecFloodFill(HDC hdc, int x, int y, COLORREF c) {
...
void Filling::NonRecFloodFill(HDC hdc, int x, int y, COLORREF c) {
...
void Filling::BaryCentric(HDC hdc, int x1, int y1, int x2, int y2, int x3, int y3, COLORREF c) {
